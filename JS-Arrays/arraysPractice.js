...
var reveresedLooper = function(lett){
  lett.reverse();
...
var divider = function(num, even, odd){
...
var removeItem = function(groveryList, itemToBeRemoved){
  for (i = 0; i < myGroceryList.length; i++){
    if (itemToBeRemoved === i){
      groveryList.slice(i, 1);
    }
  }
  return groveryList;
}

var addItem = function(groveryList, itemToBeAdded){
  groveryList.push(itemToBeAdded);
  return groveryList;
}
...
var longerArray = function(array1, array2){
...
//var breakdown = function(array, employee){
